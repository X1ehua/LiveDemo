...
public class WatermarkFilter extends BaseHardVideoFilter {
    ...
    public void onDraw(int cameraTexture, int targetFrameBuffer,
                       FloatBuffer shapeBuffer, FloatBuffer textureBuffer) {
        synchronized (syncBitmap) {
            if (needUpdate) {
        ...
        GLES20.glDrawElements(GLES20.GL_TRIANGLES, drawIndexesBuffer.limit(),
                              GLES20.GL_UNSIGNED_SHORT, drawIndexesBuffer);
        GLES20.glFinish();
